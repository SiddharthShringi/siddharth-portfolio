...
export default function Introduction() {
  return (
    <div className="flex flex-col gap-10 sm:gap-20 lg:flex-row lg:items-start lg:gap-12 xl:gap-58">
      {/* Left Content */}
      <div className="flex-1 flex flex-col items-center lg:items-start gap-8 sm:gap-10 max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
        {/* Mobile Image */}
        <motion.div
        ...
        >
          ...
          <p className="text-base md:text-lg text-foreground/80 leading-relaxed">
            ...
            <span className="font-medium text-foreground">React</span>. I have shipped features for
            e-commerce and logistics SaaS platforms, had articles featured in{' '}
            <span className="font-medium text-foreground">Ruby Weekly</span>, and have experience
            with testing, CI/CD, and AI-assisted development workflows.
          </p>
        </motion.div>
        ...
        >
          <a href="/Siddharth_Shringi_Resume.pdf" download="Siddharth_Shringi_Resume.pdf">
        ...
        <motion.div
          ...
          className="flex flex-col gap-2 text-sm text-muted-foreground items-center lg:items-start mb-2"
        >
      ...
      >
        <div className="size-56 xl:size-64 2xl:size-72 rounded-full overflow-hidden border border-border bg-muted shadow-md">
          <Image
            src="/profile.webp"
            alt="Siddharth Shringi"
            width={320}
