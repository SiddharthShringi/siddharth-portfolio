...
<Callout title="Prerequisite">
  ...
  Rack](https://siddharthshringi.com/blog/2026-06-02-rack-on-rails) article. Previously, we explored
  the Rack protocol, middleware, and the request-response cycle by building a simple Rack
...
We have already seen how to write a custom middleware in the previous [article](https://siddharthshringi.com/blog/2026-06-02-rack-on-rails). Now, let's see how to add it to the Rails middleware stack.
