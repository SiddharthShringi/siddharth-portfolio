...
tags: ['Ruby on Rails']
showToc: true
image: '/Images/blog/08-02-2026-rails-initialization-process/cover.webp'
ogImage: '/Images/blog/08-02-2026-rails-initialization-process/og-image.png'
---
...
that turns a Rails application from a pile of files and configurations
...
<Callout icon={false}>
  To learn more about Rack and its core concepts, check out this
  [article](https://siddharth-shringi.vercel.app/blog/2026-06-02-rack-on-rails).
</Callout>
...
1. First, it creates an instance of the `Rails::Server` class with the server options.
   It is a subclass of the `Rack::Server` class. The `server_options` method in
...
- It loads the config/boot file to ensure,
  Bundler and Bootsnap are set up, along with the Gemfile path.
...
Rails Initialization lifecycle and extend Rails classes.
...
- Others register hooks using `ActiveSupport.on_load`, which delays
...
![Rails Initialization Process](/Images/blog/08-02-2026-rails-initialization-process/summary.webp)
